...
//    public static final Logger entityLogger = LogManager.getLogger(HouseEquipment.class.getName());
	 ...
	 public boolean equals(Object o) {
		  ...
		  if (!(o instanceof HouseEquipment)) {
				return false;
		  }
	 ...
	 public String toString() {
		  return HouseEquipmentConstant.TOTAL_POWER + " = " + totalPower + ", "
					 + HouseEquipmentConstant.POWER_CONSUMPTION + " = " + powerConsumption + ", "
					 + HouseEquipmentConstant.IS_TURNING_ON + " = " + isTurningOn;
	 }
}
